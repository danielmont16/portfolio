...
const Works = () => (
 ...
 <section id="works">
    ...
    <span className="worksDesc"> Here are some projects created during Dr. Angela Yu's course and various personal projects. For more details, please visit my GitHub account.</span>
          <Carousel autoPlay showThumbs={true} infiniteLoop={true}>
            <div>
              <img className='worksImg'alt="Tindog Page"  src={TindogPage}
              />
              <p className="legend">Tindog Page</p>
            </div>
            <div>
              <img className='worksImg'alt="Dice Game" src={DiceGame} />
              <p className="legend">Dice Game</p>
            </div>
            <div>
              <img className='worksImg' alt="Simon Game" src={SimonGame} />
              <p className="legend">Simon Game</p>
            </div>
            <div>
              <img className='worksImg' alt="What-a-font" src={WhataFont} />
              <p className="legend">What a font!</p>
            </div>
            <div>
              <img  className='worksImg'alt="DrumKit" src={Drumkit} />
              <p className="legend">DrumKit</p>
            </div>
            <div>
              <img className='worksImg' alt="My favorite candy" src={MyfavoriteCandy} />
